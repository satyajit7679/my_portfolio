...
const Footer = () => {
  const socials = [
    {
      icon: <FaGithub />,
      link: "https://github.com/satyajit7679",
      label: "GitHub",
    },
    {
      icon: <FaLinkedin />,
      link: "https://www.linkedin.com/in/satyajit-barik-ba3962238/",
      label: "LinkedIn",
    },
    {
      icon: <FaEnvelope />,
      link: "mailto:satyajitbarik987@gmail.com",
      label: "Email",
    },
  ];
    ...
    <footer className="bg-gray-950 border-t border-gray-800 py-10 text-center relative mt-16">
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <p className="text-sm text-gray-500">
          © {new Date().getFullYear()} <span className="text-cyan-400 font-medium">Satyajit Barik</span> — Crafted with 💙 using{" "}
