...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        I love building <span className="text-cyan-400">data-driven</span> and{" "}
        <span className="text-purple-400">intelligent solutions</span> using
        modern technologies like Python, Machine Learning, and AI — turning raw
