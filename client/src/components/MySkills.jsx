...
import { SiNumpy,SiPandas,SiMysql,SiScikitlearn } from "react-icons/si";
import { FaReact, FaDatabase, FaGitAlt, FaPython, FaHtml5, FaCss3Alt, FaJsSquare } from "react-icons/fa";
...
const MySkills = () => {
  const skills = [
    ...
    { name: "Scikitlearn", icon: <SiScikitlearn size={32} /> },
